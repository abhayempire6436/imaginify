...
TransformationFormProps) => {
  ...
  const [newTransformations, setNewTransformation] = useState<Transformations | null>(null);
  ...
  const onTransformHandler = async () => {
    ...
    setTransformationConfig(
      deepMergeObjects(newTransformations, transformtationConfig)
    )
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        {creditBalance < Math.abs(creditBalance) && <InsufficientCreditsModal />}
      <CustomField 
